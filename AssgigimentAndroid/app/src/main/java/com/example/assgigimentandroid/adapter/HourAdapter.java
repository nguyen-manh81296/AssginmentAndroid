package com.example.assgigimentandroid.adapter;
...
public class HourAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (wheather.getWheatherIcon()< 10){
            url = "https://developer.accuweather.com/sites/default/files/0" + wheather.getWheatherIcon() + "-s.png";
        }else {
            url = "https://developer.accuweather.com/sites/default/files/" + wheather.getWheatherIcon() + "-s.png";
        }
